...
func _init() -> void:
	...
	# 海/滩边界的探针取 z=2000（机场矩形 z∈(-1050,600) 之外），
	# 否则这些点落在机场平地里、判的是 airport 而非海/滩
	var edges := [[-1080.1, 2000.0, "sea"], [-1079.9, 2000.0, "beach"],
			[-980.1, 2000.0, "beach"], [-979.9, 2000.0, "grass"],
			[950.1, 0.0, "desert"], [949.9, 0.0, "city"],
			[0.0, -1080.1, "mount"], [0.0, -1079.9, "grass"],
			[949.9, 949.9, "city"], [950.1, 949.9, "desert"],
			[-1900.1, -250.0, "sea"], [-1899.9, -250.0, "airport"],
			[-1000.1, -250.0, "airport"], [-999.9, -250.0, "beach"],
			[-1500.0, -1050.1, "sea"], [-1500.0, -1049.9, "airport"],
			[-1500.0, 599.9, "airport"], [-1500.0, 600.1, "sea"]]
	var ebad := 0
	for e in edges:
